...
#define MCCONF_L_BATTERY_CUT_START		31.0	// Start limiting the positive current at this voltage
#endif
...
#define MCCONF_L_RPM_MAX				29000.0	// The motor speed limit (Upper)
#endif
#ifndef MCCONF_L_RPM_MIN
#define MCCONF_L_RPM_MIN				-100000.0	// The motor speed limit (Lower)
#endif
#ifndef MCCONF_L_RPM_START
#define MCCONF_L_RPM_START				0.75		// Fraction of full speed where RPM current limiting starts
#endif
...
#define MCCONF_FOC_SL_ERPM				35000.0	// ERPM above which only the observer is used
#endif
...
#define MCCONF_FOC_FW_DUTY_START		0.97 // Start field weakening at this fraction of max duty cycle
#endif
#ifndef MCCONF_FOC_FW_RAMP_TIME
#define MCCONF_FOC_FW_RAMP_TIME			1.0 // Ramp time for field weakening current
#endif
#ifndef MCCONF_FOC_FW_Q_CURRENT_FACTOR
#define MCCONF_FOC_FW_Q_CURRENT_FACTOR	0.00 // Factor of the FW-current to feed to the Q-axis to slow motor down when setting 0 current
#endif
...
#define MCCONF_SI_WHEEL_DIAMETER		0.113 // Wheel Diameter
#endif
...
#define MCCONF_SI_BATTERY_AH			9.0 // Battery amp hours
#endif
